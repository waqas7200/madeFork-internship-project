...
class RecommendationList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final RecommendationController ctrl = Get.put(RecommendationController());

    return Obx(() {
      if (ctrl.isLoading.value && ctrl.recommendedProducts.isEmpty) {
        return SizedBox(
      ...
      return GridView.builder(
        ...
        itemBuilder: (context, index) {
          final cardW = (MediaQuery.of(context).size.width / 2) - context.rW(6);
          return RecommendationCard(item: products[index], cardWidth: cardW);
        },
      );
    });
  }
